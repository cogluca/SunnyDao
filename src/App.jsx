...
const App = () => {
        ...
        const token = useToken("0xC322426C8b86Ce75eBE8BC8631923ae3cBa5070A");

        const vote = useVote("0x67Eefb2859B50a43451c6CD86f6dDE8D368153F2");
        ...
        return (
            <div className="mint-nft">
                ...
                <button disabled={isClaiming}
                        onClick={mintNft}>{isClaiming ? "Minting..." : "Claim your NFT"}</button>
            </div>
        );
    }
;
